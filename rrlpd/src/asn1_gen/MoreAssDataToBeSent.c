...
static asn_per_constraints_t asn_PER_type_MoreAssDataToBeSent_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_MoreAssDataToBeSent_value2enum_1[] = {
	{ 0,	14,	"noMoreMessages" },
	{ 1,	20,	"moreMessagesOnTheWay" }
};
static const unsigned int asn_MAP_MoreAssDataToBeSent_enum2value_1[] = {
	1,	/* moreMessagesOnTheWay(1) */
	0	/* noMoreMessages(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_MoreAssDataToBeSent_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_MoreAssDataToBeSent_tags_1[] = {
