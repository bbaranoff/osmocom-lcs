...
static asn_per_constraints_t asn_PER_type_Ext_GeographicalInformation_constr_1 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  1,  20 }	/* (SIZE(1..20)) */,
	0, 0	/* No PER value map */
};
static const ber_tlv_tag_t asn_DEF_Ext_GeographicalInformation_tags_1[] = {
