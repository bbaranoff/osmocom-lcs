...
static asn_per_constraints_t asn_PER_memb_doppler1_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 6,  6,  0,  63 }	/* (0..63) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_dopplerUncertainty_constr_3 GCC_NOTUSED = {
...
static const ber_tlv_tag_t asn_DEF_AddionalDopplerFields_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_AddionalDopplerFields_tag2el_1[] = {
