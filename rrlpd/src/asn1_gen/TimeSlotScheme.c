...
static asn_per_constraints_t asn_PER_type_TimeSlotScheme_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_TimeSlotScheme_value2enum_1[] = {
	{ 0,	11,	"equalLength" },
	{ 1,	13,	"variousLength" }
};
static const unsigned int asn_MAP_TimeSlotScheme_enum2value_1[] = {
	0,	/* equalLength(0) */
	1	/* variousLength(1) */
};
static const asn_INTEGER_specifics_t asn_SPC_TimeSlotScheme_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_TimeSlotScheme_tags_1[] = {
