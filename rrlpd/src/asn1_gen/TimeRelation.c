...
static const int asn_MAP_TimeRelation_oms_1[] = { 1 };
static const ber_tlv_tag_t asn_DEF_TimeRelation_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_TimeRelation_tag2el_1[] = {
