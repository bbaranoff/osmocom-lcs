...
static asn_per_constraints_t asn_PER_type_GPSReferenceTimeUncertainty_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 7,  7,  0,  127 }	/* (0..127) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const ber_tlv_tag_t asn_DEF_GPSReferenceTimeUncertainty_tags_1[] = {
