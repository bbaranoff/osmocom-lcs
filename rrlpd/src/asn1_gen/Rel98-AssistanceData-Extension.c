...
static const int asn_MAP_Rel98_AssistanceData_Extension_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_Rel98_AssistanceData_Extension_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_Rel98_AssistanceData_Extension_tag2el_1[] = {
