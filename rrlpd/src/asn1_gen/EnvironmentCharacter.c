...
static asn_per_constraints_t asn_PER_type_EnvironmentCharacter_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  2,  2,  0,  2 }	/* (0..2,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_EnvironmentCharacter_value2enum_1[] = {
	{ 0,	7,	"badArea" },
	{ 1,	10,	"notBadArea" },
	{ 2,	9,	"mixedArea" }
	/* This list is extensible */
};
static const unsigned int asn_MAP_EnvironmentCharacter_enum2value_1[] = {
	0,	/* badArea(0) */
	2,	/* mixedArea(2) */
	1	/* notBadArea(1) */
	/* This list is extensible */
};
static const asn_INTEGER_specifics_t asn_SPC_EnvironmentCharacter_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_EnvironmentCharacter_tags_1[] = {
