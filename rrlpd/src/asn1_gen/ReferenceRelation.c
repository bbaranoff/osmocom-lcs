...
static asn_per_constraints_t asn_PER_type_ReferenceRelation_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_ReferenceRelation_value2enum_1[] = {
	{ 0,	17,	"secondBTSThirdSet" },
	{ 1,	18,	"secondBTSSecondSet" },
	{ 2,	16,	"firstBTSFirstSet" }
};
static const unsigned int asn_MAP_ReferenceRelation_enum2value_1[] = {
	2,	/* firstBTSFirstSet(2) */
	1,	/* secondBTSSecondSet(1) */
	0	/* secondBTSThirdSet(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_ReferenceRelation_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_ReferenceRelation_tags_1[] = {
